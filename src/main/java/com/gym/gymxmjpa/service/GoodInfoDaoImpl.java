...
public class GoodInfoDaoImpl {
    ...
    public Map<String,Object> query(Map<String,Object> map1){
        ...
        if(map1.get("goodsid")!=null && !map1.get("goodsid").equals("") && map1.get("memberid")!=null && !map1.get("memberid").equals("")){
            jpa=jpa+" and goodsid = '"+map1.get("goodsid")+"'"+" and memberid = '"+map1.get("memberid")+"'";
        }else if(map1.get("goodsid")!=null && !map1.get("goodsid").equals("")){
