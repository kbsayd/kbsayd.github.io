...
public class MenberConntroller {
    ...
    @RequestMapping("/queryforerror")
    @ResponseBody
    public Map<String,Object> query( int pageSize, int pageNumber){
        Map<String,Object>  map1=new HashMap<String,Object>();
        map1.put("qi",(pageNumber-1)*pageSize);
        map1.put("shi",pageSize);
        return menberDaoiImpl.queryforerror(map1);
    }
    /**
    ...
    /**
     * @Description: 根据会员名字查询会员信息
     */
    @RequestMapping("/cha2")
    @ResponseBody
    public Member query2(String name){

        return menberDaoiImpl.cha2(name);
    }
    ...
    @RequestMapping("/add")
    @ResponseBody
    public int add(Member member,float ssmoney ,float zlmoney){
        menberDaoiImpl.tianjia(member,ssmoney,zlmoney);
         return 1;
    }
}
