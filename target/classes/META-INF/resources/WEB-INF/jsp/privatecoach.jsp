...
<head>
    ...
    <script>
        ...
        function kan1() {
            $("#myModal4").modal("show");
            $('#ss').bootstrapTable({
                url:'${pageContext.request.contextPath}/private/query3',
                method:'post',
                contentType:"application/x-www-form-urlencoded",
                columns:[{ radio:true
                }, {
        ...
        function save(){
            ...
            // var memberStatic=$('#hystatic').val();
            $("#myModal").modal("hide") ;
         $.post('${pageContext.request.contextPath}/menber/cha',{'id':hyid},function(data){
                $("#table").bootstrapTable("load",data) ;
                    if(data.memberbalance>countprice){
                        $.post('${pageContext.request.contextPath}/private/add',{'member.memberId':hyid,'coach.coachId':jlid,'subject.subId':kcid,'count':count,'countprice':countprice,'date':date,'state':state,"remark":remark},function(data){
                            $("#table").bootstrapTable("load",data) ;
                            $.post("${pageContext.request.contextPath}/privateinfo/query",{"pageSize":opt.pageSize,"pageNumber":opt.pageNumber,"coachid":coachid,"subjectid":subjectid,"memberid":memberid},function (releset) {
                                $("#table").bootstrapTable('load',releset) ;
                            })
        ...
        function validateAdd() {
            ...
            var kh = $("#kh").val().trim();
            if(kh == null || kh == ""){
                $("#kh").parent().append("<span style='color:red'>请选择会员编号</span>");
                return false;
            }
            ...
            if(subject==-1){
                $("#subject").parent().append("<span style='color:red'>请选择课程名称</span>");
                return false;
            }
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">❤增加新私教信息</h4>
                </div>
                    ...
                    <form>
                        ...
                        <table style="margin-top:10px;border:1px solid #ccc;padding:20px;margin-bottom:20px;">
                            <tr style="margin: 20px; margin-left: 20px;padding: 20px;padding-left: 20px">
                                <td style="width:450px;padding-left: 20px"><label style="float: left;margin-top: 10px">会员编号：</label><input type="text" id="kh" style="margin-top: 10px;width: 250px" class="form-control" readonly="readonly" >
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    &nbsp;
                    <div class="modal-footer">
<%--                        <span  style="color: red;float: left" >此页面只显示会员卡状态正常且余额不为0的会员</span>--%>
                        <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <form>
                        ...
                        <table  style="width: 90%;margin: 0px auto">
                               <tr style="width: 100%">
                                   <td style="width: 280px;height: 35px;">会员编号：<span id="hykh"></span></td>
