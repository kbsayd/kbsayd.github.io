    ...
    <div class="panel-body">
        <form class="form-inline">
                <div class="form-group">
                    消费商品编号：<input id="goodsid" type="text"class="form-control" placeholder="请输入商品编号">
                    <a title='查询'  onclick="kan3()" href="#"><span class='glyphicon glyphicon-search'></span></a>
                </div>

                <div class="form-group">
                    消费会员编号：<input id="memberid" type="text"class="form-control" placeholder="请输入会员编号">
