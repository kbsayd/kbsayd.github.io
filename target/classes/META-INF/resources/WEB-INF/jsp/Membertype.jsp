    ...
    <script>
                ...
                columns:[
                    ...
                    { field:'typemoney',title:'售价',sortable: true},
                    {
                        ...
                        formatter : function(value, row, index) {
                            return "<a href='javascript:upd1("+row.typeId+")' ><span class='glyphicon glyphicon-pencil'></span></a>";
                        }
       ...
       if(!validateAdd()){
        ...
        function upd1(id){
             ...
             $('#id').val(id);
            $.post('${pageContext.request.contextPath}/metype/cha2',{'id':id},function(data){
                $("#table").bootstrapTable("load",data) ;
