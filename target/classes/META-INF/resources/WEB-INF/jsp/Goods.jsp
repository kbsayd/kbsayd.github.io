                ...
                title: '备注'
                        ...
                        formatter : function(value, row, index) {
                            return "<a title='删除' href='javascript:del1("
                                + row.goodsId + ")'><span class='glyphicon glyphicon-trash'></span></a>  | <a href='javascript:upd1("+row.goodsId+")' class='glyphicon glyphicon-pencil'>进货</a> | <a href='javascript:upd3("+row.goodsId+")' class='glyphicon glyphicon-pencil'>退货</a>";
                        }
      ...
      <div class="panel-body">
        <form class="form-inline">
            ...
            <button onclick="search()" type="button" class="btn btn-default" style="margin-top: 20px" >查询</button>
             <button type="button" class="btn btn-default" onclick="ss()" style="float: right; margin-top: 20px" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-plus"></span>添加商品</button>
        </form>
      </div>
