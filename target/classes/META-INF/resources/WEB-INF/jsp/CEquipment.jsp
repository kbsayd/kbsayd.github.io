...
<head>
    ...
    <script type="text/javascript">
        ...
        function tianjia() {
            ...
            var brand =$('#upbrand').val();
            var price =$('#upprice').val();
            var function1 =$('#upfunction').val();
            $.post("${pageContext.request.contextPath}/qc/insert",{"eqName":name,"eqUnit":unit,"eqNum":num,"eqRemark":remark,"eqBrand":brand,"eqPrice":price,"eqFunction":function1},function (releset) {
                if(releset != null){
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        <label  class="control-label">器材单位:</label>
                        <input type="text" class="form-control" id="upunit">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label  class="control-label">器材备注:</label>
                        <input type="text" class="form-control" id="upremark">
                    </div>
                    <div class="form-group">
                        <label  class="control-label">器材品牌:</label>
                        <input type="text" class="form-control" id="upbrand">
                    </div>
                    <div class="form-group">
                        <label  class="control-label">器材价格:</label>
                        <input type="text" class="form-control" id="upprice">
                    </div>
                    <div class="form-group">
                        <label  class="control-label">功能要求:</label>
                        <input type="text" class="form-control" id="upfunction">
                    </div>
                </form>
            </div>
